  ...
  <div class="card">
    <div class="card-body login-card-body">
	 <div class="panel-heading">
			...
			<center><h4 class="panel-title">Presensi WFH SMANSA</h4></center>
			<p><center>Silahkan Login Menggunakan Akun Siransija</center></p>
		</div>
      <br>
<?php include 'login_query.php'?>
      ...
      <form method="POST">
        <div class="input-group mb-3">
         <input type="text" maxlength="10" value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" name="usernamex" class="form-control" placeholder="Username" required="required"/>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" value="<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>" name="password" id="myPassword" placeholder="Password...">
		 ...
		 <div class="input-group">
									  ...
									  <div class="checkbox">
                    <input id="customCheck1" name="remember" type="checkbox" id="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?>>
                    <label for="remember_me">Simpan Akun </label> 
                </div>
                                    </div>
		<input type="checkbox" onclick="myFunction()"> Lihat Password </input>
		<br>
		<br>
